...
class _LoginScreen3State extends State<LoginScreen3>
  ...
  bool _password2Validator = false;

  bool _emailLoginValidator = false;
  bool _passwordLoginValidator = false;
  ...
  Widget HomePage() {
    return new Container(
      ...
      child: new Column(
        children: <Widget>[
          Container(
            padding: EdgeInsets.only(top: 210.0, bottom: 30),
            child: Center(
              child: Icon(
                Icons.headset_mic,
                color: Colors.white,
      ...
      body: Container(
        ...
        child: new ListView(
          children: <Widget>[
            Container(
              padding:
                  EdgeInsets.only(bottom: 40, top: 70, left: 70, right: 70),
              child: Center(
                child: Icon(
                  Icons.headset_mic,
                  color: Colors.redAccent,
                  ...
                  new Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        errorText:
                            _emailLoginValidator ? 'Email requires!' : null,
                      ),
                    ),
                  ),
                ],
                  ...
                  new Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: '*********',
                        hintStyle: TextStyle(color: Colors.grey),
                        errorText: _passwordLoginValidator
                            ? 'Password requires!'
                            : null,
                      ),
                    ),
      ...
      body: Container(
        ...
        child: new ListView(
          children: <Widget>[
            Container(
              padding:
                  EdgeInsets.only(bottom: 30, top: 70, left: 70, right: 70),
              child: Center(
                child: Icon(
                  Icons.headset_mic,
                  color: Colors.redAccent,
                  ...
                  new Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: Colors.grey),
                          errorText:
                              _nameValidator ? 'Name can\'t be blank' : null),
                    ),
                  ),
                ],
              ),
                  ...
                  new Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: Colors.grey),
                          errorText:
                              _emailValidator ? 'Email can\'t be blank' : null),
                    ),
                  ),
                ],
              ),
                                ...
                                onPressed: () async => {
                                  setState(() {
                                    ...
                                    _password2Controller.text !=
                                        ...
                                        ? _password2Validator = true
                                        : _password2Validator = false;
                                  ...
                                  if (!_passwordValidator &&
                                      ...
                                      !_emailValidator)
                                    {
                                      signupInfo = await model.signup(
                                          _emailController.text,
                                          _nameController.text,
                                          _passwordController.text,
                                          _password2Controller.text),
                                      if (signupInfo["hasError"])
                                        {
                                          print("In signup ingfo"),
                                          showDialog(
                                              context: context,
